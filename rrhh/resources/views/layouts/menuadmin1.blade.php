...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{ url('') }}/demo2/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.4" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url({{ url('') }}/demo2/dist/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
										...
										<div class="navi navi-spacer-x-0 pt-5">
                                            ...
                                            <a target="_blank" class="btn btn-light-primary font-weight-bold" href="{{ route('logout') }}"
		...
		<script src="{{ url('') }}/demo2/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.4"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{ url('') }}/demo2/dist/assets/js/pages/widgets.js?v=7.0.4"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
