...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="{{ url('') }}/demo2/dist/assets/css/pages/wizard/wizard-4.css?v=7.0.4" rel="stylesheet" type="text/css" />
		<!--end::Page Custom Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="{{ url('') }}/demo2/dist/assets/plugins/global/plugins.bundle.css?v=7.0.4" rel="stylesheet" type="text/css" />
		<link href="{{ url('') }}/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.4" rel="stylesheet" type="text/css" />
		<link href="{{ url('') }}/demo2/dist/assets/css/style.bundle.css?v=7.0.4" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{{url('') }}/demo2/dist/assets/assets/media/logos/favicon.ico" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url({{ url('') }}/demo2/dist/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Wizard 4</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Wizard 4</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
		...
		<script src="{{ url('') }}/demo2/dist/assets/plugins/global/plugins.bundle.js?v=7.0.4"></script>
		<script src="{{ url('') }}/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.4"></script>
		<script src="{{ url('') }}/demo2/dist/assets/js/scripts.bundle.js?v=7.0.4"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{ url('') }}/demo2/dist/assets/js/pages/custom/wizard/wizard-4.js?v=7.0.4"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
        ...
        <div class="container">
                ...
                <form action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="dni_trabajador" name="dni_trabajador" value="{{ old('dni_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">nombres_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="nombres_trabajador" name="nombres_trabajador" value="{{ old('nombres_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">apellido_paterno_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="apellido_paterno_trabajador" name="apellido_paterno_trabajador" value="{{ old('apellido_paterno_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">apellido_materno_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="apellido_materno_trabajador" name="apellido_materno_trabajador" value="{{ old('apellido_materno_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">fecha_nacimiento_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="date" placeholder="fecha_nacimiento_trabajador" name="fecha_nacimiento_trabajador" value="{{ old('fecha_nacimiento_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">edad_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="edad_trabajador" name="edad_trabajador" value="{{ old('edad_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">cargo_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="cargo_trabajador" name="cargo_trabajador" value="{{ old('cargo_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">correo_electronico_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="correo_electronico_trabajador" name="correo_electronico_trabajador" value="{{ old('correo_electronico_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">direccion_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="direccion_trabajador" name="direccion_trabajador" value="{{ old('direccion_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
					<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="profesion_trabajador" name="profesion_trabajador" value="{{ old('profesion_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">colegiatura_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="colegiatura_trabajador" name="colegiatura_trabajador" value="{{ old('colegiatura_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">fecha_ingreso_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="date" placeholder="fecha_ingreso_trabajador" name="fecha_ingreso_trabajador" value="{{ old('fecha_ingreso_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">fecha_baja_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="date" placeholder="fecha_baja_trabajador" name="fecha_baja_trabajador" value="{{ old('fecha_baja_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">estado_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="estado_trabajador" name="estado_trabajador" value="{{ old('estado_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">estado_plataforma_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="text" placeholder="estado_plataforma_trabajador" name="estado_plataforma_trabajador" value="{{ old('estado_plataforma_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-5 col-sm-12">fecha_modificacion_trabajador</label>
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                            <input class="form-control "  type="date" placeholder="fecha_modificacion_trabajador" name="fecha_modificacion_trabajador" value="{{ old('fecha_modificacion_trabajador') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-7 col-sm-12 is-valid">
                            <div class="typeahead">
                                <select name="estado_trabajador" class="form-control form-control-lg form-control-solid">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <a type="reset" href="{{ url('') }}/trabajadores/" class="btn btn-secondary">Salir</a>
                </div>
            </div>
        </div>
    </form>
