                            ...
                            <div class="card-header border-0 pt-5">
                                <div class="card-title">
                                    <div class="card-label">
                                        <div class="font-weight-bolder">Afectuacion Presupuestal</div>
                                        <div class="font-size-sm text-muted mt-2">890,344 Soles - Ultimo mes Devenge</div>
                                    </div>
                                </div>
                                ...
                                <div class="flex-grow-1 card-spacer-x">
                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{ url('') }}/demo2/dist/assets/media/svg/misc/006-plurk.svg" alt="" class="h-50" />
                                                </div>
                                            </div>
                                            <div>
                                                <a href="#" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">Reg. 276</a>
                                            </div>
                                        </div>
                                        <div class="label label-light label-inline font-weight-bold text-dark-50 py-4 px-3 font-size-base">S/. 120 000</div>
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex align-items-center justify-content-between mb-10">
                                        <div class="d-flex align-items-center mr-2">
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{ url('') }}/demo2/dist/assets/media/svg/misc/015-telegram.svg" alt="" class="h-50" />
                                                </div>
                                            </div>
                                            <div>
                                                <a href="#" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">Reg. 728</a>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center mr-2">
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{ url('') }}/demo2/dist/assets/media/svg/misc/003-puzzle.svg" alt="" class="h-50" />
                                                </div>
                                            </div>
                                            <div>
                                                <a href="#" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">Reg. 1025</a>
                    ...
                    <div class="col-xl-8">
                        <div class="row">
                            <div class="col-xl-3">
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url({{ url('') }}/demo2/dist/assets/media/bg/bg-9.jpg)">
                                    <!--begin::Body-->
                                    <div class="card-body d-flex flex-column">
                                        <!--begin::Title-->
                                        <a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">Año 2024</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Body-->
                                </div>
                            ...
                            <div class="col-xl-9">
                                ...
                                <div class="card card-custom gutter-b" style="height: 150px">
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="mr-2">
                                            <h3 class="font-weight-bolder">Mantenimiento de Sistema</h3>
                                            <div class="text-dark-50 font-size-lg mt-2">Modificacion de planillas  </div>
                                        </div>
                                        <a href="#" class="btn btn-primary font-weight-bold py-3 px-6">Modificar</a>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Mixed Widget 10-->
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url({{ url('') }}/demo2/dist/assets/media/svg/patterns/taieri.svg)">
                                    <!--begin::Body-->
                                    <div class="card-body d-flex align-items-center">
                                        <div>
                                            <h3 class="text-white font-weight-bolder line-height-lg mb-5">Registrar Nuevos
                                            <br />Trabajadores</h3>
                                            <a href='#' class="btn btn-success font-weight-bold px-6 py-3">Registrar</a>
                                        </div>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                            <div class="card-body">
                                                ...
                                                <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3"><a href="#" class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">23</a></div>
                                                <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1">Cargos</a>
                                            </div>
                                        </div>
                                        <!--end::Tiles Widget 11-->
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-custom gutter-b" style="height: 150px">
                                            <div class="card-body">
                                                ...
                                                <div class="text-dark font-weight-bolder font-size-h2 mt-3"><a href="#" class="text-dark font-weight-bolder font-size-h2 mt-3">65</a></div>
                                                <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">Trabajadores</a>
                                            </div>
                                        </div>
                                        <!--end::Tiles Widget 12-->
                                    </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url({{ url('') }}/demo2/dist/assets/media/stock-600x600/img-16.jpg)">
                                    <!--begin::Body-->
                                    <div class="card-body d-flex flex-column align-items-start justify-content-start">
                                        <div class="p-1 flex-grow-1">
                                            <h3 class="text-white font-weight-bolder line-height-lg mb-5">Generar Planilla
                                            <br />de trabajadores</h3>
                                        </div>
                                        <a href='#' class="btn btn-link btn-link-warning font-weight-bold">Crear Planilla
