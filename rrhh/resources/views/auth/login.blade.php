...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<link href="{{ url('') }}/demo2/dist/assets/css/pages/login/classic/login-5.css?v=7.0.4" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{ url('') }}/demo2/dist/assets/media/bg/bg-2.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<form class="form" method="POST" action="{{ route('login') }}">
								...
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('email') is-invalid @enderror" type="text" placeholder="Email" name="email" value="{{ old('email') }}" autocomplete="off" autofocus  required /> 
									@error('email')
						...
						<div class="login-forgot">
							<div class="mb-20">
								...
								<a class="opacity-40 font-weight-normal" href="{{ route('password.request') }}">
		...
		<script src="{{ url('') }}/demo2/dist/assets/js/pages/custom/login/login-general.js?v=7.0.4"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
